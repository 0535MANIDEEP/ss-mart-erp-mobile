...
class BillRemoteDataSourceImpl implements BillRemoteDataSource {
  ...
  BillItem _parseBillItem(Map<String, dynamic> json) {
    return BillItem(
      ...
      cgstAmount: json['cgstAmount'] as int? ?? 0,
      sgstAmount: json['sgstAmount'] as int? ?? 0,
      igstAmount: json['igstAmount'] as int? ?? 0,
      taxRuleVersion: json['taxRuleVersion'] as String? ?? 'v1',
  ...
  Map<String, dynamic> _billToJson(Bill b) {
    return {
      ...
      'taxRuleVersion': b.taxRuleVersion,
